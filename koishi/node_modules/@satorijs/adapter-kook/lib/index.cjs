...
var adaptChannel = /* @__PURE__ */ __name((data) => ({
  id: data.id,
  type: data.is_category ? import_core.Universal.Channel.Type.CATEGORY : data.type === 1 ? import_core.Universal.Channel.Type.TEXT : data.type === 2 ? import_core.Universal.Channel.Type.VOICE : import_core.Universal.Channel.Type.TEXT,
  name: data.name,
...
function adaptReaction(data, body, session) {
  if (data.channel_type === "GROUP") {
