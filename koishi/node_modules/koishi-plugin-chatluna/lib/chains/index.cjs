  ...
  getMessageText(message) {
    return message.map((element) => {
      ...
      if (Array.isArray(element)) {
        return import_koishi.h.select(element, "text").toString();
      }
