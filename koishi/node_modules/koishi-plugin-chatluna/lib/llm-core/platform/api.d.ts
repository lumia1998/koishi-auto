...
export declare abstract class ModelRequester<T extends ClientConfig = ClientConfig, R extends ChatLunaPlugin.Config = ChatLunaPlugin.Config> implements BaseRequester {
    ...
    constructor(ctx: Context, _configPool: ClientConfigPool<T>, _pluginConfig: R, _plugin: ChatLunaPlugin);
    ...
    protected abstract completionStreamInternal(params: ModelRequestParams): AsyncGenerator<ChatGenerationChunk>;
    init(): Promise<void>;
    dispose(model?: string, id?: string): Promise<void>;
    post(url: string, data: any, params?: fetchType.RequestInit): Promise<fetchType.Response>;
    get(url: string, headers?: Record<string, string>, params?: fetchType.RequestInit): Promise<fetchType.Response>;
