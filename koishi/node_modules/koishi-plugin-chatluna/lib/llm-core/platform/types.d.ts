...
export interface ChatLunaChainInfo {
    ...
    createFunction: (params: CreateChatLunaLLMChainParams) => ChatLunaLLMChainWrapper;
}
...
export declare function isPlatformModelInfo(model: any): model is PlatformModelInfo;
