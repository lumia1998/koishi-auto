...
import { ChatLunaChainInfo, ChatLunaTool, CreateChatLunaLLMChainParams, CreateClientFunction, CreateToolParams, CreateVectorStoreFunction, CreateVectorStoreParams, ModelInfo, ModelType, PlatformClientNames, PlatformModelInfo } from 'koishi-plugin-chatluna/llm-core/platform/types';
...
export declare class PlatformService {
    ...
    registerClient(name: PlatformClientNames, createClientFunction: CreateClientFunction): () => void;
    ...
    registerChatChain(name: string, description: Dict<string>, createChatChainFunction: (params: CreateChatLunaLLMChainParams) => ChatLunaLLMChainWrapper): () => void;
    unregisterChatChain(name: string): void;
    listPlatformModels(platform: PlatformClientNames, type: ModelType): ComputedRef<ModelInfo[]>;
    ...
    getClient(platform: string): Promise<ComputedRef<BasePlatformClient<import("./config").ClientConfig, import("./model").ChatLunaChatModel | import("./model").ChatLunaBaseEmbeddings>>>;
    refreshClient(client: BasePlatformClient, platform: string, config?: RunnableConfig): Promise<void>;
    createClient(platform: string, config?: RunnableConfig): Promise<BasePlatformClient<import("./config").ClientConfig, import("./model").ChatLunaChatModel | import("./model").ChatLunaBaseEmbeddings>>;
    getTool(name: string): {
        createTool(params: CreateToolParams): StructuredTool<import("@langchain/core/tools").ToolSchemaBase, any, any, any>;
        selector: (history: import("@langchain/core/messages").BaseMessage[]) => boolean;
        authorization?: (session: import("koishi").Session) => boolean;
        name?: string;
        id?: string;
    };
    private _createTool;
    createChatChain(name: string, params: CreateChatLunaLLMChainParams): ChatLunaLLMChainWrapper;
    dispose(): void;
}
