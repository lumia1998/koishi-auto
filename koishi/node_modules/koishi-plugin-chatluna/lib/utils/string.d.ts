import { BaseMessage, MessageContent, MessageContentComplex, MessageContentImageUrl, MessageContentText } from '@langchain/core/messages';
...
export declare function isMessageContentImageUrl(message: MessageContentComplex): message is MessageContentImageUrl;
export declare function isMessageContentText(message: MessageContentComplex): message is MessageContentText;
...
export declare function getSystemPromptVariables(session: Session, config: Config, room: ConversationRoom): {
    name: string;
    date: string;
    bot_id: string;
    is_group: boolean;
...
export declare function formatToolCall(tool: string, arg: any, log: string): string;
export declare function formatUserPromptString(config: Config, presetTemplate: PresetTemplate, session: Session, prompt: string, room: ConversationRoom): Promise<import("@chatluna/shared-prompt-renderer").RenderResult>;
export {};
