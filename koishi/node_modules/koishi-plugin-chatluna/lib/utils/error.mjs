...
var ChatLunaErrorCode = /* @__PURE__ */ ((ChatLunaErrorCode2) => {
  ...
  ChatLunaErrorCode2[ChatLunaErrorCode2["PRESET_NOT_FOUND"] = 302] = "PRESET_NOT_FOUND";
  ...
  ChatLunaErrorCode2[ChatLunaErrorCode2["VECTOR_STORE_NOT_ACTIVE"] = 313] = "VECTOR_STORE_NOT_ACTIVE";
  ChatLunaErrorCode2[ChatLunaErrorCode2["VECTOR_STORE_EMBEDDING_ERROR"] = 314] = "VECTOR_STORE_EMBEDDING_ERROR";
  ChatLunaErrorCode2[ChatLunaErrorCode2["VECTOR_STORE_EMBEDDING_DIMENSION_MISMATCH"] = 315] = "VECTOR_STORE_EMBEDDING_DIMENSION_MISMATCH";
