...
__export(string_exports, {
  ...
  formatUserPromptString: () => formatUserPromptString,
  ...
  getSystemPromptVariables: () => getSystemPromptVariables,
  ...
  isMessageContentImageUrl: () => isMessageContentImageUrl,
  isMessageContentText: () => isMessageContentText,
  rollDice: () => rollDice,
  selectFromList: () => selectFromList,
  transformMessageContentToElements: () => transformMessageContentToElements
});
