define(['exports'], (function (exports) { 'use strict';
  ...
  var IANAZone = /*#__PURE__*/function (_Zone) {
     ...
     * @return {string|null}
     */;
    IANAZone.normalizeZone = function normalizeZone(zone) {
      if (!zone) {
        return null;
      }
      try {
    ...
    function IANAZone(name) {
      ...
      var normalizedName = IANAZone.normalizeZone(name);
      /** @private **/
      _this.valid = normalizedName != null;
      ...
      /** @private **/
      _this.zoneName = normalizedName && normalizedName.toLowerCase() === name.toLowerCase() ? normalizedName : name;
      return _this;
    }
  ...
  function getCachedRTF(locString, opts) {
    ...
    var _opts = opts;
      _opts.base;
      var cacheKeyOpts = _objectWithoutPropertiesLoose(_opts, _excluded$1); // exclude `base` from the options
  ...
  var Duration = /*#__PURE__*/function (_Symbol$for) {
    ...
    _proto.toHuman = function toHuman(opts) {
      ...
      var l = orderedUnits$1.map(function (unit) {
        var convertUnit = humanizeUnitConversion[unit];
        if (convertUnit === null) return null;
        var val = _this.values[unit];
        if (convertUnit) {
          var val2 = _this.values[convertUnit];
          if (val2) {
            var _val;
            val = ((_val = val) != null ? _val : 0) + val2 * _this.matrix[convertUnit][unit];
          }
        }
  ...
  var Interval = /*#__PURE__*/function (_Symbol$for) {
    ...
    Interval.fromISO = function fromISO(text, opts) {
      var _ref = opts || {},
        zone = _ref.zone,
        setZone = _ref.setZone,
        restOpts = _objectWithoutPropertiesLoose(_ref, _excluded);
      ...
      if (s && e) {
        ...
        try {
          ...
          start = DateTime.fromISO(s, _extends({}, restOpts, {
            zone: zone,
            setZone: true
          }));
        ...
        var end, endIsValid;
        try {
          var _parseISOIntervalEnd = parseISOIntervalEnd(e),
            vals = _parseISOIntervalEnd[0],
            parsedZone = _parseISOIntervalEnd[1];
          var endParseOpts = _extends({}, restOpts, {
  ...
  var DateTime = /*#__PURE__*/function (_Symbol$for) {
    ...
    DateTime.fromObject = function fromObject(obj, opts) {
      ...
      var tsNow = (_opts$overrideNow = opts.overrideNow) != null ? _opts$overrideNow : Settings.now(),
