  ...
  toHuman(opts = {}) {
    ...
    const l = orderedUnits$1.map(unit => {
      ...
      if (convertUnit) {
        ...
        if (val2) {
          var _val;
          val = ((_val = val) != null ? _val : 0) + val2 * this.matrix[convertUnit][unit];
        }
      }
...
class DateTime {
  ...
  static fromObject(obj, opts = {}) {
    ...
    const tsNow = (_opts$overrideNow = opts.overrideNow) != null ? _opts$overrideNow : Settings.now(),
