...
var GenerateImg = class extends Service {
	...
	async getTimeDifference(dateString) {
		const apiDateTime = DateTime.fromFormat(dateString, "yyyy-MM-dd HH:mm:ss", { zone: "UTC+8" });
