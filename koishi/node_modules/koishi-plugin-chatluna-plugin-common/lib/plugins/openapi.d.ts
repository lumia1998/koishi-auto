...
export declare class OpenAPIPluginTool extends StructuredTool implements AIPluginToolParams {
    ...
    /** @ignore */
    _call(args: Record<string, any>): Promise<string>;
    static fromAction(action: Omit<AIPluginToolParams, 'name' | 'description' | 'schema' | 'meta' | 'parameters' | 'requestBody'> & {
...
export declare namespace OpenAPIV3_1 {
    ...
    export type Document<T extends object = object> = Modify<Omit<OpenAPIV3.Document<T>, 'paths' | 'components'>, {
        info: InfoObject;
    ...
    export type PathsObject<T extends object = object, P extends object = object> = Record<string, (PathItemObject<T> & P) | undefined>;
    export type HttpMethods = OpenAPIV3.HttpMethods;
    export type PathItemObject<T extends object = object> = Modify<OpenAPIV3.PathItemObject<T>, {
        servers?: ServerObject[];
        parameters?: (ReferenceObject | ParameterObject)[];
    }> & {
        [method in HttpMethods]?: OperationObject<T>;
    };
    export type OperationObject<T extends object = object> = Modify<OpenAPIV3.OperationObject<T>, {
        parameters?: (ReferenceObject | ParameterObject)[];
...
export declare namespace OpenAPIV3 {
    interface Document<T extends object = object> {
        openapi: string;
        info: InfoObject;
        servers?: ServerObject[];
        paths: PathsObject<T>;
